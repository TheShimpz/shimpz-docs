...
<svelte:head>
  <title>Power human requests — Shimpz docs</title>
  <link rel="canonical" href="https://docs.shimpz.com/developers/assistants/requests/" />
  <meta
    name="description"
    content="Pause a Shimpz Power for attributable approval, closed input, or platform authentication."
  />
</svelte:head>

<nav class="docs-breadcrumb" aria-label="Breadcrumb">
  <a href="/developers/">Developers</a><span aria-hidden="true">/</span><strong>Power requests</strong>
</nav>

<header class="docs-page-header">
  <span class="section-label">Human-in-the-loop SDK</span>
  <h1>Pause a Power for one accountable human decision</h1>
  <p class="docs-lede">
    A Power can request approval, one closed input field, or fresh platform authentication. Shimpz pauses the
    operation, identifies the exact Assistant and Power to the human, and resumes only after a valid response.
  </p>
</header>
...
<section class="guide-section" aria-labelledby="choose-title">
  ...
  <dl>
    ...
    <dd>Ask Shimpz to prove a platform assurance class without exposing the factor to the Power.</dd>
  </dl>
</section>
...
<section class="guide-section" aria-labelledby="declare-title">
  ...
  <CodeBlock label="Declared human request capabilities" title="powers/create_record.py" variant="code" {...data.power} />
  <p>
    Every exact kind must appear in <code>@power(human_requests=[...])</code>. An undeclared kind is rejected before
...
<aside class="scope-note" aria-labelledby="before-action-title">
  ...
  <p>
    A request ends the current operating-system process. Shimpz later re-runs the same immutable Power with a
...
<section class="guide-section" aria-labelledby="outcome-title">
  ...
  <ul>
    <li>Approval, valid input, or successful assurance resumes the logical Power.</li>
    ...
    <li>One Power may request at most 8 decisions; one Team turn may request at most 16.</li>
