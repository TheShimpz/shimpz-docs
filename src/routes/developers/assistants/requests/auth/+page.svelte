...
<header class="docs-page-header">
  ...
  <p class="docs-lede">
    An Action names an assurance class, not a credential field. Shimpz chooses and completes the trusted ceremony.
...
<section class="guide-section" aria-labelledby="blocking-title">
  ...
  <p>
    ...
    <code>auth:phishing-resistant</code> — in <code>@action(human_requests=[...])</code>. The SDK call returns
    ...
    reauthentication password inside the same pending ceremony; the Action remains paused and receives nothing until
...
<section class="guide-section" aria-labelledby="reauth-title">
  ...
  <CodeBlock label="Fresh password assurance" title="Inside a declared Action" variant="code" {...data.reauth} />
  <RequestScreenshot
    src="/developers/action-requests/auth-reauth.png"
...
<section class="guide-section" aria-labelledby="factor-title">
  ...
  <CodeBlock label="Fresh second-factor assurance" title="Inside a declared Action" variant="code" {...data.secondFactor} />
  <RequestScreenshot
    src="/developers/action-requests/auth-second-factor.png"
...
<section class="guide-section" aria-labelledby="passkey-title">
  ...
  />
  <RequestScreenshot
    src="/developers/action-requests/auth-phishing-resistant.png"
...
<section class="guide-section" aria-labelledby="profile-title">
  ...
  <p>
    ...
    both profiles, choose <code>reauth</code> or expose separate Actions with clearly declared requirements.
  </p>
</section>
